 ...
 * @16/07/2025
 */
public class glyptoLand20 extends JFrame implements ActionListener {
    JMenuBar menuBar;
    JMenu menu;
    JMenuItem menuItem;
    JButton button;
    ...
    glyptoLand20(){
        ...
        button.setText("<html>GLYPTODON LAND!<br>Press aywhere to play <br> <br> wasd:Movement <br> q:Change Grid <br> e:Pickup Food <br> f:Feed Food <br>esc:Exit </html>");
 ...
 if (buttonb==true){
    ...
    Color skincolor = new Color (188,145,95);
                    ...
                    g2.fillRect(30 +(64*0),84+(64*0),34,34); // base of shell
                    g2.fillRect(44 +(64*0),72+(64*0),6,15);// tail
                    g2.setColor(skincolor);
                    g2.fillRect(64 +(64*0),86+(64*0),4,8);// rbfoot
                    g2.fillRect(64 +(64*0),106+(64*0),4,8);//rf foot
                    g2.fillRect(26 +(64*0),86+(64*0),4,8);//lb foot
                    g2.fillRect(26 +(64*0),106+(64*0),4,8);//rf foot
                    g2.fillRect(40 +(64*0),118+(64*0),14,12);//base ofhead
                    g2.setColor(brownshell);
                    g2.fillRect(43 +(64*0),119+(64*0),8,8);// head shell
                    g2.fillRect(45 +(64*0),127+(64*0),4,2);
                    g2.setColor(Color.BLACK);
                    g2.fillRect(42 +(64*0),127+(64*0),2,2);//l e0e
                    g2.fillRect(50 +(64*0),127+(64*0),2,2);// r eye);
                    
                    Color feathercolor = new Color (182,169,194);
                    g2.setColor(feathercolor);
                    g2.fillRect(35 +(64*1),90+(64*1),18,12);// bod1
                    g2.fillRect(37 +(64*1),84+(64*1),14,6);// bod1
                    g2.fillRect(37 +(64*1),102+(64*1),14,6);// body
                    g2.fillRect(39 +(64*1),108+(64*1),10,2);// body
                    g2.fillRect(41 +(64*1),110+(64*1),6,4);// body
                    g2.fillRect(42 +(64*1),114+(64*1),4,2);// body
                    Color beakcolor = new Color (218,228,245);
                    g2.setColor(beakcolor);
                    g2.fillRect(43 +(64*1),116+(64*1),2,3);
                    Color beakendcolor = new Color (130,97,7);
                    g2.setColor(beakendcolor);
                    g2.fillRect(42 +(64*1),119+(64*1),4,4);
                    g2.fillRect(43 +(64*1),123+(64*1),2,1);
                    g2.setColor(feathercolor);
                    g2.fillRect(42 +(64*1),114+(64*1),4,2);// body

                    Color tailcolor = new Color (206,209,252);
                    g2.setColor(tailcolor);
                    g2.fillRect(41 +(64*1),82+(64*1),6,4);//tail
                    g2.fillRect(42 +(64*1),81+(64*1),4,6);//tail
                    g2.setColor(Color.BLACK);

                    g2.fillRect(41 +(64*1),112+(64*1),2,2);//l eye
                    g2.fillRect(45 +(64*1),112+(64*1),2,2);// r e2e
                    
                    //bush
                    g2.setColor(color);
                    g2.fillRect(10 +(64*2),70+(64*2),64,64); 
                    
                    g2.setColor(darkgreen);
                    g2.fillRect(18+(64*2),78+(64*2),48,48);
                    g2.fillRect(14+(64*2),82+(64*2),54,38);
    ...
    public static String[][] Array2(String[][] interactgrid) {
        ...
        for (int x=0;x<8; x++){ 
            for (int y=0;y<8; y++){
                ...
                //System.out.println(currentgrid[x][y]);
                //System.out.println(interactgrid[x][y]);
            }
        }        
        return (interactgrid);
    }
